...
////    sets the value.Syntax for both is that they start with either get or set,
...
////    The this keyword is used to refer to the current object.However,
...
//
////    Why Encapsulation?
////    Better control of class attributes and methods Class attributes can be made read-only (if you only use the get method),
